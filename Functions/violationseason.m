function violcount = violationseason(Data,Vall,draw)
...
% constraints
% This function is different from violation.m becasue here, the function
% does not generate the validation scenarios itself
violcount = 0;
Ntest = length(Vall);
for k=1 :Ntest
    X = Data.F*Data.xi+Data.G*Data.U+Data.H*Vall(:,1,k);
    test1 = Data.Tmax;
    test2 = Data.Tmin;
    viol =0;
